...
#symRNN = bool that sets if using a Symmetric RNN wavefunction
RNNEnergy, varRNNEnergy = run_1DTFIM(numsteps = 10**3, systemsize = 20, Bx = +1, num_units = 50,  num_layers = 1, numsamples = 500, learningrate = 5e-3, seed = 111, symRNN= False)
